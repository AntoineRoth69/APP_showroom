#http://codingwithruss.com/pygame/breakout/paddle.html
...
while run:
    ...
    if not live_ball:
        if game_over == 0:
            ...
            draw_text('PAUSED!', font, text_col, 240, screen_height // 2 + 50)
            draw_text('CLICK ANYWHERE TO RESUME', font, text_col, 100, screen_height // 2 + 100)
